...
4. 平台聚合能力：外部子服务入口（iframe/跳转）、体验服务挂载、统一入口
5. 性能与稳定性：缓存/索引、限流、审计、可观测
...
- 产品形态：核心 Chat 自研，但可保留外部子服务入口作为补充能力
...
- 与 OpenWebUI 的关系：
  - 当前口径：核心 Chat 自研，不把外部 UI 作为主路径；但允许受控的 iframe/跳转子服务入口作为平台补充能力
